...
import { ChangeDetectionStrategy, Component, inject, DestroyRef, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
let ServicesComponent = class ServicesComponent {
    ...
    isStripeConfigured = !!this.stripePublishableKey && this.stripePublishableKey.startsWith('pk_');
    tiers = [
        {
            id: 'simple',
            title: 'Simple',
