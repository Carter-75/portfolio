    ...
    >
      {imageError ? (
        ...
        >
          ...
          <div className={styles.certFallbackLabel}>MOS</div>
...
export default function Footer() {
  ...
  return (
    <footer className={`footer ${styles.footerRoot}`} role="contentinfo">
        ...
        <div className="columns is-vcentered">
          ...
          <div className="column is-two-thirds has-text-centered-mobile">
            <p className={`is-size-6 ${styles.footerCopy}`}>
              &copy; {currentYear}{' '}
              <span className={styles.brandGradient}>Carter Moyer</span>
              . All Rights Reserved.
            </p>
            <p className={`is-size-7 ${styles.footerDisclaimer}`}>
              Source code available for demonstration purposes only.
              May not be copied or distributed without explicit permission.
            </p>

            <nav className="mt-5" aria-label="Social media links">
              <div className={styles.socialHeadingWrap}>
                <p className={styles.socialHeading}>Connect</p>
              </div>
              <div className={styles.socialRow}>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Carter Moyer on Fiverr"
                  className={`${styles.socialLink} footer-social-link`}
          ...
          <div className="column is-one-third has-text-centered">
            ...
            <section aria-label="Professional certifications">
              <h4 className={styles.certTitle}>Certifications</h4>
