        ...
        <div className="container">
          <div className="columns is-vcentered">
            ...
            <div className="column is-two-thirds has-text-centered-mobile">
              ...
              <div className="mt-4">
                <div style={{ marginBottom: '1rem' }}>
                  <p style={{ color: '#48c774', fontSize: '0.9rem', fontWeight: '600', marginBottom: '0.5rem' }}>Connect With Me</p>
                </div>
            ...
            <div className="column is-one-third has-text-centered">
              ...
              <div>
                <h4 style={{ color: '#48c774', fontSize: '0.9rem', marginBottom: '1rem' }}>Professional Certifications</h4>
