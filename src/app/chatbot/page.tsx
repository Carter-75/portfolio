...
export default function ChatbotPage() {
      ...
      <div className="container">
        ...
        <FadeInWrapper translateY={30} delay={200}>
          <div className="box" style={bubbleStyle}>
            ...
            <div style={{ 
              ...
              <div style={{ textAlign: 'center', color: '#f0f0f0', fontFamily: 'monospace', fontSize: '0.9rem' }}>
                <div style={{ marginBottom: '1.5rem' }}>
                  <div style={{ padding: '1rem', background: 'rgba(72, 199, 116, 0.15)', borderRadius: '8px', marginBottom: '0.5rem' }}>
                    <strong style={{ color: '#48c774' }}>Frontend (React/Next.js)</strong>
                    <div style={{ fontSize: '0.8rem', color: '#a0a0a0', marginTop: '0.3rem' }}>Chat UI Component</div>
                  </div>
                  <div style={{ color: '#e85d04', fontSize: '1.5rem' }}>↓ HTTP Request</div>
                </div>

                <div style={{ marginBottom: '1.5rem' }}>
                  <div style={{ padding: '1rem', background: 'rgba(72, 199, 116, 0.15)', borderRadius: '8px', marginBottom: '0.5rem' }}>
                    <strong style={{ color: '#48c774' }}>Next.js API Route</strong>
                    <div style={{ fontSize: '0.8rem', color: '#a0a0a0', marginTop: '0.3rem' }}>/api/chatbot</div>
                  </div>
                  <div style={{ color: '#e85d04', fontSize: '1.5rem' }}>↓ Future: HTTP to Python Backend</div>
                </div>

                <div style={{ marginBottom: '1.5rem' }}>
                  <div style={{ padding: '1rem', background: 'rgba(232, 93, 4, 0.15)', borderRadius: '8px', marginBottom: '0.5rem' }}>
                    <strong style={{ color: '#e85d04' }}>Python Flask Backend</strong>
                    <div style={{ fontSize: '0.8rem', color: '#a0a0a0', marginTop: '0.3rem' }}>AI Processing & LLM Integration</div>
                  </div>
                  <div style={{ color: '#e85d04', fontSize: '1.5rem' }}>↓ SQL Queries</div>
                </div>

                <div>
                  <div style={{ padding: '1rem', background: 'rgba(232, 93, 4, 0.15)', borderRadius: '8px' }}>
                    <strong style={{ color: '#e85d04' }}>MySQL Database</strong>
                    <div style={{ fontSize: '0.8rem', color: '#a0a0a0', marginTop: '0.3rem' }}>Conversations & Portfolio Data</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="content">
              <h3 style={{ color: '#48c774', marginBottom: '1rem' }}>Architecture Components:</h3>
              <ul style={{ color: '#d0d0d0', lineHeight: '1.8' }}>
                <li><strong style={{ color: '#f0f0f0' }}>Frontend:</strong> React component with TypeScript, CSS modules for styling, real-time chat interface</li>
                <li><strong style={{ color: '#f0f0f0' }}>API Layer:</strong> Next.js API route handling requests, response generation, error handling</li>
                <li><strong style={{ color: '#f0f0f0' }}>Backend:</strong> Python Flask server with MySQL integration, conversation storage, content search</li>
                <li><strong style={{ color: '#f0f0f0' }}>Database:</strong> MySQL for persistent storage, conversation history, portfolio content synchronization</li>
              </ul>
            </div>
          </div>
        </FadeInWrapper>
              ...
              {[
                ...
                <div key={index} className="column is-half">
                  <div style={{
                    ...
                    <h3 style={{ color: '#e85d04', fontWeight: '700', marginBottom: '0.8rem' }}>
                      {feature.title}
                    </h3>
              ...
              {[
                ...
                <div key={index} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                    ...
                    <h3 style={{ color: '#e85d04', fontWeight: '700', fontSize: '1.2rem', margin: 0 }}>
                      {item.challenge}
                    </h3>
                  </div>
                  
                  <div style={{ marginBottom: '1rem' }}>
                    <strong style={{ color: '#f0f0f0' }}>Challenge:</strong>
                  ...
                  <div>
                    <strong style={{ color: '#48c774' }}>Solution:</strong>
                    <p style={{ color: '#d0d0d0', marginTop: '0.5rem', lineHeight: '1.6' }}>
                      {item.solution}
                    </p>
                  </div>
          ...
          <div className="box" style={bubbleStyle}>
            ...
            <div className="columns is-multiline">
              <div className="column is-half">
                <h3 style={{ color: '#48c774', marginBottom: '1rem' }}>Frontend</h3>
                <ul style={{ color: '#d0d0d0', lineHeight: '1.8' }}>
              ...
              <div className="column is-half">
                <h3 style={{ color: '#48c774', marginBottom: '1rem' }}>Backend</h3>
                <ul style={{ color: '#d0d0d0', lineHeight: '1.8' }}>
              ...
              <div className="column is-half">
                <h3 style={{ color: '#48c774', marginBottom: '1rem' }}>Infrastructure</h3>
                <ul style={{ color: '#d0d0d0', lineHeight: '1.8' }}>
              ...
              <div className="column is-half">
                <h3 style={{ color: '#48c774', marginBottom: '1rem' }}>Future Additions</h3>
                <ul style={{ color: '#d0d0d0', lineHeight: '1.8' }}>
        ...
        <FadeInWrapper translateY={30} delay={600}>
          <div className="box" style={bubbleStyle}>
            ...
            <div className="content">
              <h3 style={{ color: '#48c774', marginBottom: '1rem' }}>React Component Example</h3>
  ...
  // Handle response...
              ...
              <h3 style={{ color: '#48c774', marginTop: '2rem', marginBottom: '1rem' }}>Python Backend Example</h3>
        ...
        <FadeInWrapper translateY={30} delay={700}>
          <div className="box" style={bubbleStyle}>
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ color: '#f0f0f0', fontSize: '1.1rem', marginBottom: '2rem', lineHeight: '1.7' }}>
              ...
              <div style={{ 
                ...
                <p style={{ color: '#48c774', fontWeight: '600', fontSize: '1.1rem' }}>
